          ...
          <div class="flex flex-wrap -mx-4 justify-center">
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/shipping" class="hover:underline py-1 block">Shipping</Link>
                </li>
                <li>
                  <Link to="/refund" class="hover:underline py-1 block">Refund</Link>
                </li>
                <li>
                  <Link to="/promotion" class="hover:underline py-1 block">Promotion</Link>
                </li>
              </ul>
            </div>
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/about" class="hover:underline py-1 block">About</Link>
                </li>
                <li>
                  <Link to="/career" class="hover:underline py-1 block">Career</Link>
                </li>
                <li>
                  <Link to="/contact-us" class="hover:underline py-1 block">Contact Us</Link>
                </li>
              </ul>
            </div>
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/terms-conds" class="hover:underline py-1 block"
                    >Terms & Conds</Link>
                </li>
                <li>
                  <Link to="/privacy-policy" class="hover:underline py-1 block"
                    >Privacy Policy</Link>
                </li>
                <li>
                  <Link to="/for-developer" class="hover:underline py-1 block"
                    >For Developer</Link>
                </li>
              </ul>
            </div>
